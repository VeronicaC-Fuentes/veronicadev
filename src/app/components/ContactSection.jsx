          ...
          <div className="mt-14 w-full grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="rounded-2xl border border-[#8F67E8]/40 bg-[#F3EFF5] p-7 shadow-[0_2px_28px_0_#8F67E815]">
                <h3 className="text-xl font-bold text-[#5E60CE] mb-4 tracking-tight">
                  {t("contact.location.title")}
                </h3>
                <p className="text-base text-[#3F3351]">
                  {t("contact.location.line1")}{" "}
                  <span className="text-[#B9B6D3]">({t("contact.location.nomad")})</span>.<br />
                  <span className="text-[#3F3351]">{t("contact.location.line2")}</span>
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-[#8F67E8]/40 bg-[#F3EFF5] p-7 shadow-[0_2px_28px_0_#8F67E815]">
                ...
                <div className="space-y-3 text-base">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#3F3351] font-medium">
                      +51 977968602 <span className="text-[#B9B6D3]">({t("contact.direct.pe")})</span>
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
              ...
              <div className="rounded-2xl border border-[#8F67E8]/40 bg-[#F3EFF5] p-7 shadow-[0_2px_28px_0_#8F67E815]">
                ...
                <div className="flex gap-4 text-2xl">
                  <a
                    ...
                    className="text-[#3F3351] hover:text-[#8F67E8] transition"
                  ...
                  <a
                    ...
                    className="text-[#3F3351] hover:text-[#5E60CE] transition"
                    aria-label="LinkedIn"
                  >
                    <FaLinkedinIn />
                  </a>
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2 rounded-full cursor-pointer font-semibold text-[#F3EFF5] text-sm sm:text-base transition-all duration-200 bg-[#3F3351] border mx-auto shadow-lg"
                style={{ border: "2px solid #8F67E8", letterSpacing: "0.04em", fontWeight: 700, minWidth: 140 }}
              >
                {t("contact.form.cta")}
      ...
      <footer className="bg-[#F3EFF5] text-[#3F3351] py-6 sm:py-8 px-4 sm:px-6 lg:px-8 border-t border-[#8F67E8]/10">
        <div className="max-w-6xl mx-auto text-center space-y-4">
          <p className="text-sm tracking-wide font-medium">
            &copy; {new Date().getFullYear()} Verónica Cruces. {t("footer.rights")}
          </p>
        </div>
      </footer>
    </>
