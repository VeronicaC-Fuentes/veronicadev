...
export const ALL_PROJECTS = [
 {
  ...
  { 
    ...
    description: "Módulo de gestión y validación de datos de contactos (RUC/DNI)."
  },
  { 
    id: "odoo_products", 
    featured: false, 
    url: "https://github.com/VeronicaC-Fuentes/Modulos_personalizados_Odoo_17/tree/main/product_name_customization", 
    image: "/portfolio/odoo-products-1.png", 
    tech: "Odoo 17, Python, XML, PostgreSQL",
    description: "Personalización avanzada de nombres y códigos de productos."
  },
  { 
    id: "giuni", 
    featured: false, 
    ...
    tech: "Odoo 18 Website, Owl, JavaScript",
    description: "Sitio web inmobiliario conectado en tiempo real con Odoo."
  },
  { 
    id: "epp", 
    featured: false, 
  ...
  { 
    ...
    tech: "Next.js 15, Tailwind CSS",
    description: "Web institucional para empresa de ingeniería y gas."
  },
];